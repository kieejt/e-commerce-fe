                    ...
                    if (cartItems[e.id]> 0) {
                        return ( 
                            <tr key={e.id} className='border-b border-slate-900/20 text-gray-700 p-6 medium-14 text-center'>
                                <td className='flexCenter'><img src={e.image} alt="prdctImg" height={43} width={43} className='rounded-lg ring-1 ring-slate-900/5 my-1'></img></td>
                                <td>
                                    <div className='line-clamp-3 text-gray-800'>{e.name}</div>
                                </td>
                                <td className='text-gray-800'>${e.new_price}</td>
                                <td className='w-16 h-16 bg-white text-gray-800'>{cartItems[e.id]}</td>
                                <td className='text-gray-800'>${e.new_price * cartItems[e.id]}</td>
                                <td>
