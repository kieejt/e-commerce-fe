...
function Category({category, banner}) {
  return (
    <section className="max_padd_container py-12 xl:py-28">
      <div>
        <div>
          <img src={banner} alt="" className="block my-7 nx-auto" />
        </div>
        <div className="flexBetween my-8 nx-2">
          <h5><span className="front-bold">Showing 1-12</span> out of 36 products</h5>
